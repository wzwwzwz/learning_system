<template>
  <div class="cropper-component">
    <div class="info-item">
      <div class="btn-box">
        <label class="btn  el-button el-button--primary" for="uploads">选择图片</label>
        <el-button type="primary" @click="finish('blob')">上传头像</el-button>

        <input type="file" id="uploads" :value="imgFile" style="position:absolute; clip:rect(0 0 0 0);width: 1px;"
